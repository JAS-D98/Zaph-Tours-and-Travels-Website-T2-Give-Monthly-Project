    ...
    <footer className="p-8 bg-footer text-white mt-16 dark:bg-black">
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          <p className="text-xl font-bold mt-3">
            Zaph <span className="text-green">Tours</span>
          </p>
          <p className="mt-2 text-base leading-7 text-white-400 sm:max-w-sm">
      ...
      <a href="https://jasperwambuguport.netlify.app">
        <p className="mt-1 items-center flex w-full justify-center">
          <span className="text-blue-500 italic">Jasper Wambugu</span>
        </p>
      </a>
    </footer>
  );
