...
export default function Navbar() {
  return (
    <div className='flex w-full px-5 py-1 justify-between items-center border-b-2 capitalize'>
      <div className='flex items-center'>
        <div className='w-[4em] overflow-hidden object-cover'>
          <img src={logo} alt="image of logo icon" width="100%" height="100%"/>
        </div>
        <p className='text-xl font-semibold'>Zaph<br/> <span className='text-green'>Tours</span></p>
      </div>
